<template>
  <v-container class="my-8 recent-products-container">
    <div class="text-center mb-6">
      <h2 class="text-h4 font-weight-bold mb-2 section-title">Productos Recientes</h2>
      <p class="text-subtitle-1 section-subtitle">Las últimas novedades en nuestra tienda</p>
    </div>
          ...
          <v-card-text class="pa-4">
            ...
            <div class="d-flex align-center mb-2">
              <div class="product-rating">
                <!-- Implementación manual de estrellas con Font Awesome -->
